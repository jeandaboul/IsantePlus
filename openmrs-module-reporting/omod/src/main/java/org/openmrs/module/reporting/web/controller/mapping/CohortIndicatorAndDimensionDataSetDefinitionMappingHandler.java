 ...
 */
@Handler(supports=CohortIndicatorAndDimensionDataSetDefinition.class, order=50)
public class CohortIndicatorAndDimensionDataSetDefinitionMappingHandler extends DefinitionMappingHandler {
	
	/**
	 * @see DefinitionMappingHandler#getCreateUrl(Class)
	 */
	public String getCreateUrl(Class<? extends Definition> type) {
		return "/module/reporting/datasets/cohortIndicatorAndDimensionDatasetEditor.form?type="+type.getName();
	}
}
